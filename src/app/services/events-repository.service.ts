...
export class EventsRepository {
  private categories: CategoryModel[] = [
    { id: 1, name: 'Sports', color: "#1E90FF", icon: "fa-solid fa-volleyball" },
    { id: 2, name: 'Concerts', color: "#FF6347", icon: "fa-solid fa-music" },
    { id: 3, name: 'Movies', color: "#4B7782", icon: "fa-solid fa-clapperboard" },
    { id: 4, name: 'Technology', color: "#32CD32", icon: "fa-solid fa-microchip" }
  ];
